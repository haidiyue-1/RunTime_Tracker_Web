const config = {
    dev: {
        API_BASE: import.meta.env.VITE_API_BASE || 'https://drum-quilt-euros-boards.trycloudflare.com/api', // 默认开发环境
    ...
    prod: {
        API_BASE: import.meta.env.VITE_API_BASE || 'https://drum-quilt-euros-boards.trycloudflare.com/api', // 默认生产环境
        ADMIN_URL: import.meta.env.VITE_ADMIN_URL || 'https://runtime-tracker-admin.pages.dev/',
        SITE_TITLE: import.meta.env.VITE_SITE_TITLE || 'RunTime Tracker'
    }
};
